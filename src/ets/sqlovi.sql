select * from USER;
select * from USER where id > 5000000;
select * from GENRE;
select * from MOVIE;
...
DELETE FROM GENRE where id > 5000000;
DELETE FROM MOVIE where id > 5000000;
DELETE FROM COMMENT where id > 5000000;
DELETE FROM RATING where id > 5000000;
DELETE FROM MOVIE_GENRE where MOVIE_ID > 5000000;
DELETE FROM GENRE_MOVY where MOVY > 5000000;
DELETE FROM USER where id > 5000000;
DELETE FROM GENRE;
DELETE FROM COMMENT;
DELETE FROM RATING;
